...
class Sql
{
     ...
     */
    static function up() {
        $q1 = "CREATE TABLE users (id INTEGER PRIMARY KEY, user VARCHAR(50), pass VARCHAR(60), email varchar(50), age varchar(50), bio varhar(50), isadmin INTEGER, image VARCHAR(100) );";
